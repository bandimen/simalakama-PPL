    ...
    <div class="flex h-16 items-center justify-between">
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          ...
          <x-nav-link-mhs href="/akademik" :active="request()->is('tenagaPendidik')" >Home</x-nav-link-mhs>
          <x-nav-link-mhs href="/akademik/tambahruang" :active="request()->is('akademik/tambahruang')" >Ruang Kuliah</x-nav-link-mhs>
