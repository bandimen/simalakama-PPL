      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <x-nav-link-mhs href="/kaprodi" :active="request()->is('kaprodi')" >Home</x-nav-link-mhs>
            <x-nav-link-mhs href="/kaprodi/jadwalKuliah" :active="request()->is('kaprodi/jadwalKuliah')" >Jadwal Kuliah</x-nav-link-mhs>
            <x-nav-link-mhs href="/kaprodi/mataKuliah" :active="request()->is('kaprodi/mataKuliah')" >Mata Kuliah</x-nav-link-mhs>
    ...
    class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
            ...
            $userRoles = $user->roles;
            if ($userRoles->count() > 1) {
                echo '<a href="/select-role" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Select role</a>';
            }
            ?>
        </div>
        <div class="mt-3 space-y-1 px-2">
