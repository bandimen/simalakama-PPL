 ...
 <div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-64 h-screen p-12 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
   <div class="py-4 overflow-y-auto">
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="/kaprodi/jadwal" :active="request()->is('kaprodi/jadwal')" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
