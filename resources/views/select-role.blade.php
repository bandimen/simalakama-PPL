                        ...
                        @foreach ($roles as $role)
                            <li>
                                ...
                                <label for="role-{{ $role->name }}" 
                                       class="flex items-center p-3 text-base font-bold border text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 peer-checked:bg-blue-500 peer-checked:text-white transition">
