                ...
                @if ($currentPeriod)
                    ...
                    @elseif ($activePeriodType == 'perubahan')
                        ...
                        <div id="alert-additional-content-1"
                            ...
                            <div class="mt-2 mb-4 text-sm">
                                Masa perubahan IRS dimulai pada tanggal {{ $currentPeriod->periode_perubahan_start }}
                                hingga {{ $currentPeriod->periode_perubahan_end }}.
                            </div>
                        </div>
                        ...
                        <section
                            ...
                            <p class="font-normal text-sm text-gray-700 dark:text-gray-400">Silakan pilih waktu untuk
                                setiap mata kuliah yang diambil.</p>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="border p-2 bg-gray-100 text-center" style="width: 80px;">
                                                    Waktu</th>
                                                <th class="border p-2 bg-gray-100 text-center" data-day="Senin">Senin
                                                </th>
                                                <th class="border p-2 bg-gray-100 text-center" data-day="Selasa">
                                                    Selasa</th>
                                                <th class="border p-2 bg-gray-100 text-center" data-day="Rabu">Rabu
                                                </th>
                                                <th class="border p-2 bg-gray-100 text-center" data-day="Kamis">Kamis
                                                </th>
                                                <th class="border p-2 bg-gray-100 text-center" data-day="Jumat">Jumat
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                        ...
                        <div id="bottomSheet"
                            ...
                            <div id="content" class="p-4 hidden">
                                ...
                                <table id="bottomSheetTable" class="w-full border-collapse border border-gray-300">
                                    ...
                                    <tbody>
                                        <tr id="emptyMessage">
                                            <td colspan="6" class="text-center text-gray-500">Belum ada jadwal yang
                                                dipilih.</td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    @elseif ($activePeriodType == 'pembatalan')
                        <div id="alert-additional-content-1"
                            ...
                            <div class="mt-2 mb-4 text-sm">
                                Masa pembatalan IRS dimulai pada tanggal {{ $currentPeriod->periode_pembatalan_start }}
                                hingga {{ $currentPeriod->periode_pembatalan_end }}.
                            </div>
                        </div>
                    ...
                    @else
                        <div id="alert-additional-content-2"
                            ...
                            <div class="mt-2 mb-4 text-sm">
                                Masa IRS sudah selesai. Tidak ada lagi pengisian, perubahan, dan pembatalan IRS untuk
                                semester ini, silakan nikmati perkuliahan dengan baik. Miaw.
                            </div>
                            <div class="flex">
                                <a href="/mhs">
                                    <button type="button"
