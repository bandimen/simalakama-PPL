...
class IrsDetailsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $irsDetails = [
            ...
            // id irs = 4 ( nopal smt 1 th 2022/2023 gasal)
            [
                'irs_id' => 4,
                'kodemk' => 'PAIK6101',
            ...
            // id irs = 5 ( nopal smt 2 th 2022/2023 genap)
            [
                'irs_id' => 5,
                'kodemk' => 'PAIK6201',
            ...
            // id irs = 6 ( nopal smt 3 th 2023/2024 gasal)
            [
                'irs_id' => 6,
                'kodemk' => 'PAIK6301',
                'jadwal_kuliah_id' => 7,
            ...
            [
             ...
             // id irs = 7 ( nopal smt 4 th 2023/2024 genap)
             [
                'irs_id' => 7,
                'kodemk' => 'PAIK6401',
                'jadwal_kuliah_id' => 55,
